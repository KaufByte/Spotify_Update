"""
Django settings for SpotifyBacl project.
...
SECRET_KEY = 'django-insecure-p!625ug8+cvcn_5n3!+o0!*=yh2i^a9zkjp%=7hd(!i_+m&oe*'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # Разрешаем запросы с React
]
